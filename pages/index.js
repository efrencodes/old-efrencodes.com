	...
	return (
		<div className={styles.container}>
			<Head>
				...
				<meta property="og:type" content="Efrén Martínez Rodríguez -- Front-end engineer" />
				<meta property="og:description" content="I´m FrontEnd Enginner from Queretaro, Mexico. I code, write and build stuff on internet." />
				<meta property="og:image" content="" />
				// Twitter Card
				<meta property="twitter:card" content="summary_large_image" />
				<meta property="twitter:url" content="https://efrenmartinez.dev" />
				<meta property="twitter:title" content="Efrén Martínez Rodríguez -- Front-end engineer" />
				<meta property="twitter:description" content="I´m FrontEnd Enginner from Queretaro, Mexico. I code, write and build stuff on internet." />
				<meta property="twitter:image" content="" />
				<meta property="twitter:creator" content="@efrenmartinezmx" />
				<meta property="twitter:site" content="@efrenmartinezmx" />
				<meta property="twitter:image:alt" content="Efrén Martínez Rodríguez -- Front-end engineer" />
				<link
					rel="icon"
